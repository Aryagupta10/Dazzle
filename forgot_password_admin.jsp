...
<%
    try{
        if(request.getParameter("btn_submit")!=null)
        {
            ...
            ResultSet rs=stat.executeQuery("select security_ques from admin where email='"+email2+"'");
            ...
            PreparedStatement pst1 = conn.prepareStatement("update admin set password=? where email=?" );
