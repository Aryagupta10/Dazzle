      ...
      <div class="container">
        ...
        <form >
            ...
            <div class="form-group">
                ...
                <input type="text" name="security_ques" placeholder="What is your birth place ?">
            </div>
            
            
            <button class="btn" name="btn_reg">Sign Up</button>
            
            
            
            <div style="text-align:center">
                <p align="ceter">Already have an account ?<a href="login_admin.jsp " style="display:inline-block"> Login</a>
...
<%
    try{
        if(request.getParameter("btn_reg")!=null)
        {
            ...
            String query="insert into admin(aname,phone_number,address,email,password,security_ques)values('"+request.getParameter("aname")+"',"+request.getParameter("ph_no")+",'"+request.getParameter("address")+"','"+request.getParameter("email")+"','"+request.getParameter("password")+"','"+request.getParameter("security_ques")+"')";
            String queryToFindDuplicate =" SELECT * FROM admin where email='"+request.getParameter("email")+"'";
